...
class DocumentSix {
  ...
  async getDocumentSixByDocumentId(documentId) {
    try {
  ...
  async approvedDocumentSix(values, documentId) {
    try {
  ...
  async getTablesSixForAuthority() {
    try {
      const response = await axios.get(
  ...
  async authorityTableSixApproved(value, tableId) {
    try {
      const response = await axios.put(
