...
const DocumentSevenPDF = ({ document }) => {
  Font.register({
    family: "Kanit",
...
const DownloadDocumentSevenPDF = ({ document }) => {
  return (
    <div>
      <PDFDownloadLink
        document={<DocumentSevenPDF document={document} />}
        fileName="ใบคำร้องขอลงทะเบียนเรียน.pdf"
      >
...
export default DownloadDocumentSevenPDF;
