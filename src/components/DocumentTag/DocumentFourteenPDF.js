...
const DocumentFourteenPDF = ({ document }) => {
  Font.register({
    family: "Kanit",
...
const DownloadDocumentFourteenPDF = ({ document }) => {
  return (
    <div>
      <PDFDownloadLink
        document={<DocumentFourteenPDF document={document} />}
        fileName="ใบคำร้องขอใบรับรองความประพฤติ.pdf"
      >
...
export default DownloadDocumentFourteenPDF;
