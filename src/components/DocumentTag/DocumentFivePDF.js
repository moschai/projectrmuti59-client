...
const DocumentFivePDF = ({ document }) => {
  Font.register({
    family: "Kanit",
...
const DownloadDocumentFivePDF = ({ document }) => {
  return (
    <div>
      <PDFDownloadLink
        document={<DocumentFivePDF document={document} />}
        fileName="ใบคำร้องขอลาพักการเรียน/รักษาสภาพการเป็นนักศึกษา.pdf"
      >
...
export default DownloadDocumentFivePDF;
