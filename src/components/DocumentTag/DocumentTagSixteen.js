...
const DocumentTagSixteen = ({ document }) => {
  return (
          ...
          <Row justify="center">
            ...
            <Col sm={24} className="text-center">
              ...
              <span className="FontSize">
                {approveStatus(
                  document.type_sixteen.signature
                    .deputy_dean_research_status_sig
                )}
              </span>
              <br />
              <span className="FontThick">สถานะการอนุมัติ คณบดี : </span>
              <span className="FontSize">
                {approveStatus(document.type_sixteen.signature.dean_status_sig)}
              </span>
              <br />
              <Divider />
            </Col>
...
export default DocumentTagSixteen;
