...
const DocumentThreePDF = ({ document }) => {
  Font.register({
    family: "Kanit",
...
const DownloadDocumentThreePDF = ({ document }) => {
  return (
    <div>
      <PDFDownloadLink
        document={<DocumentThreePDF document={document} />}
        fileName="ใบคำร้องขอคืนสภาพการเป็นนักศึกษา.pdf"
      >
...
export default DownloadDocumentThreePDF;
