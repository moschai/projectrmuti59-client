...
const DownloadDocumentTenPDF = ({ document }) => {
  return (
    <div>
      <PDFDownloadLink
        document={<DocumentTenPDF document={document} />}
        fileName="ใบคำร้องขอลงทะเบียนเรียนเทียบรายวิชา.pdf"
      >
...
export default DownloadDocumentTenPDF;
