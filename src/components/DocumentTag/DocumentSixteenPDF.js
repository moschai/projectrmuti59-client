...
const DocumentSixteenPDF = ({ document }) => {
  Font.register({
    family: "Kanit",
...
const DownloadDocumentSixteenPDF = ({ document }) => {
  return (
    <div>
      <PDFDownloadLink
        document={<DocumentSixteenPDF document={document} />}
        fileName="ใบคำร้องขอสำเร็จการศึกษาล่าช้า.pdf"
      >
...
export default DownloadDocumentSixteenPDF;
