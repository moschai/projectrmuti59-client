...
const DocumentTwelvePDF = ({ document }) => {
  Font.register({
    family: "Kanit",
...
const DownloadDocumentTwelvePDF = ({ document }) => {
  return (
    <div>
      <PDFDownloadLink
        document={<DocumentTwelvePDF document={document} />}
        fileName="ใบคำร้องขอลาออกจากการเป็นนักศึกษา.pdf"
      >
...
export default DownloadDocumentTwelvePDF;
