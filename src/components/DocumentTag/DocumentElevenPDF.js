...
const DocumentElevenPDF = ({ document }) => {
  Font.register({
    family: "Kanit",
...
const DownloadDocumentElevenPDF = ({ document }) => {
  return (
    <div>
      <PDFDownloadLink
        document={<DocumentElevenPDF document={document} />}
        fileName="ใบคำร้องขอเปลี่ยนประวัติข้อมูล.pdf"
      >
...
export default DownloadDocumentElevenPDF;
