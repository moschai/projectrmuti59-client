...
const DocumentNinePDF = ({ document }) => {
  Font.register({
    family: "Kanit",
...
const DownloadDocumentNinePDF = ({ document }) => {
  return (
    <div>
      <PDFDownloadLink
        document={<DocumentNinePDF document={document} />}
        fileName="ใบคำร้องขอชำระเงินล่าช้า.pdf"
      >
...
export default DownloadDocumentNinePDF;
