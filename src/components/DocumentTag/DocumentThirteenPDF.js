...
const DocumentThirteenPDF = ({ document }) => {
  Font.register({
    family: "Kanit",
...
const DownloadDocumentThirteenPDF = ({ document }) => {
  return (
    <div>
      <PDFDownloadLink
        document={<DocumentThirteenPDF document={document} />}
        fileName="ใบคำร้องขอเอกสารทางการศึกษา.pdf"
      >
...
export default DownloadDocumentThirteenPDF;
