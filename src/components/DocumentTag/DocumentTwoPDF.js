...
const DownloadDocumentTwoPDF = ({ document }) => {
  return (
    <div>
      <PDFDownloadLink
        document={<DocumentTwoPDF document={document} />}
        fileName="ใบคำร้องขอกลับเข้าศึกษา.pdf"
      >
...
export default DownloadDocumentTwoPDF;
