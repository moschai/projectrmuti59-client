...
const DocumentFifteenPDF = ({ document }) => {
  Font.register({
    family: "Kanit",
...
const DownloadDocumentFifteenPDF = ({ document }) => {
  return (
    <div>
      <PDFDownloadLink
        document={<DocumentFifteenPDF document={document} />}
        fileName="ใบคำร้องขอสำเร็จการศึกษา.pdf"
      >
...
export default DownloadDocumentFifteenPDF;
