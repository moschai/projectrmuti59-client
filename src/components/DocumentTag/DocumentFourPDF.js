...
const DocumentFourPDF = ({ document }) => {
  Font.register({
    family: "Kanit",
...
const DownloadDocumentFourPDF = ({ document }) => {
  return (
    <div>
      <PDFDownloadLink
        document={<DocumentFourPDF document={document} />}
        fileName="ใบคำร้องขอลงทะเบียนเกิน/ต่ำกว่าเกณฑ์.pdf"
      >
...
export default DownloadDocumentFourPDF;
