...
const DocumentTagFive = ({ document }) => {
  return (
        ...
        <>
          ...
          <Row justify="center">
            ...
            <Col sm={24} className="text-center">
              ...
              <span className="FontSize">
                {approveStatus(document.type_five.signature.advisor_status_sig)}
              </span>
              <br />
              <span className="FontThick">
              ...
              <span className="FontSize">
                {approveStatus(document.type_five.signature.dean_status_sig)}
              </span>
              <br />
              <Divider />
            </Col>
...
export default DocumentTagFive;
