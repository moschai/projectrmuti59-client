...
const DocumentEightPDF = ({ document }) => {
  Font.register({
    family: "Kanit",
...
const DownloadDocumentEightPDF = ({ document }) => {
  return (
    <div>
      <PDFDownloadLink
        document={<DocumentEightPDF document={document} />}
        fileName="ใบคำร้องขอเปลี่ยนกลุ่มเรียน.pdf"
      >
...
export default DownloadDocumentEightPDF;
