...
const ApproveFormDocFiveHs = ({
  ...
  const ref = useRef();
  const [showotherfivest, setShowotherfivest] = useState(false);
  const [form] = useForm();
  ...
  return (
    ...
    >
      <Form onFinish={onFinish} form={form} id="approveForm">
        <Form.Item name="selectapprovefive" label="ความคิดเห็น">
          <Radio.Group>
            <Radio value="1">นักศึกษาเข้ารับราชการทหาร</Radio>
            <Radio value="2">
              นักศึกษาลาพักการศึกษา/รักษาสภาพการเป็นนักศึกษาครั้งแรก
            </Radio>
            <Radio value="3">
              นักศึกษาลาพักการศึกษาเกิน 2 ภาคการศึกษาติดต่อกันแล้ว
            </Radio>
          </Radio.Group>
        </Form.Item>

        <div style={{ paddingLeft: 10 }}>
          <Form.Item name="otherfivest" label="(ในกรณีอื่นๆ)">
            <Checkbox
              onChange={(e) => {
                setShowotherfivest(e.target.checked);
              }}
            />
          </Form.Item>
...
export default ApproveFormDocFiveHs;
