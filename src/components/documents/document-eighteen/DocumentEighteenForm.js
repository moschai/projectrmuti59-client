...
// import DocumentEighteenService from "../../../services/DocumentEighteenService";
...
//   };
// };
// const DocumentEighteenForm = ({ title }) => {
...
//   const createDocumentEighteen = async (values) => {
//     setCreating(true);
//     try {
//       const documentEighteenResponse = await DocumentEighteenService.createDocumentSix(
//         values
//       );
//       form.resetFields();
//       Modal.success({
...
//         }}
//       >
//         <h2 className="text-center">แบบคำร้องขอเพิ่มที่นั่ง(สำรอง)</h2>
...
//                       <Col>
//                         <Form.Item
//                           name={[field.name, "id_std"]}
//                           fieldKey={[field.fieldKey, "id_std"]}
//                           rules={rules}
//                         >
//                           {/* <Input
...
//                       <Col>
//                         <Form.Item
//                           name={[field.name, "name_std"]}
//                           fieldKey={[field.fieldKey, "name_std"]}
//                           rules={rules}
//                         >
...
//                       <Col>
//                         <Form.Item
//                           name={[field.name, "surname_std"]}
//                           fieldKey={[field.fieldKey, "surname_std"]}
//                           rules={rules}
//                         >
...
//                       <Col>
//                         <Form.Item
//                           name={[field.name, "name_major"]}
//                           fieldKey={[field.fieldKey, "name_major"]}
//                           rules={rules}
//                         >
...
//   }
// };
// export default DocumentEighteenForm;
